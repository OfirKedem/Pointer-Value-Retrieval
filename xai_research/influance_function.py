...
def compute_influence(run_id: str, epoch: int, num_test_points: int = 1, use_cuda=False):
    """
    ...
    if_config['test_sample_num'] = num_test_points

    ptif.calc_img_wise(if_config, model, trainloader, testloader)
